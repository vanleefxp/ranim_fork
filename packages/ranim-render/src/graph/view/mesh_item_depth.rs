use crate::{
    ...
    pipelines::MeshItemDepthPipeline,
    primitives::viewport::ViewportGpuPacket,
};

pub struct MergedMeshItemDepthNode;

impl ViewRenderNodeTrait for MergedMeshItemDepthNode {
    type Query = ();
    ...
    fn run(
        ...
        rpass.set_pipeline(
            &ctx.pipelines
                .get_or_init::<MeshItemDepthPipeline>(ctx.wgpu_ctx),
        );
